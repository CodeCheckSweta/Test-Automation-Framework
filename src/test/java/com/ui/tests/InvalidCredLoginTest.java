...
public class InvalidCredLoginTest extends TestBase{
	...
	private static final String INVALID_EMAIL_ADDRESS = "sweta.singh@gmail.com";
	private static final String INVALID_PASSWORD = "Qwerty1234!";

	@Test(description = "Verify that a proper error message is shown for the user when they enter invalid credentials", groups = { 
			"sanity", "e2e", "smoke"})
